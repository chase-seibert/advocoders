...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company._branding_enabled'
        db.add_column('advocoders_company', '_branding_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company._branding_enabled'
        db.delete_column('advocoders_company', '_branding_enabled')
