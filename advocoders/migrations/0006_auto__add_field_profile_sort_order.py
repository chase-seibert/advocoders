...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.sort_order'
        db.add_column(u'advocoders_profile', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.sort_order'
        db.delete_column(u'advocoders_profile', 'sort_order')


    models = {
        u'advocoders.company': {
        ...
        u'advocoders.profile': {
            'Meta': {'object_name': 'Profile'},
            'blog': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['advocoders.Company']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
