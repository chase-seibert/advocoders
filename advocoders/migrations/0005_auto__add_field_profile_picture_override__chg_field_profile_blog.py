...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.picture_override'
        db.add_column('advocoders_profile', 'picture_override',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Profile.blog'
        db.alter_column('advocoders_profile', 'blog', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'Profile.picture_override'
        db.delete_column('advocoders_profile', 'picture_override')


        # Changing field 'Profile.blog'
        db.alter_column('advocoders_profile', 'blog', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    models = {
        'advocoders.company': {
            'Meta': {'object_name': 'Company'},
            '_branding_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'background_color': ('colorful.fields.RGBColorField', [], {'default': "'#FFFFFF'", 'max_length': '7', 'blank': 'True'}),
            ...
            'link_color': ('colorful.fields.RGBColorField', [], {'default': "'#0080c0'", 'max_length': '7', 'blank': 'True'}),
        ...
        'advocoders.profile': {
            ...
            'picture_override': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
